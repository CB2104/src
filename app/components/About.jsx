    ...
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        <div className='flex-1'>
          ...
          I am a experienced Frontend Developer with over a
          ...
          <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2x1 '>
            {infoList.map(({icon, iconDark, title, description}, index)=>(
              <li className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-emerald-100 hover:-translate-y-1 duration-500 hover:shadow-[4px_4px_0_#000]' key={index}>
